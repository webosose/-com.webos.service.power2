...
WaitObjectWait(WaitObj *obj, int ms)
{
    ...
    else
    {
        ...
        // OYK_2013_07_26 : Below fomula is wrong, milliseconds * 10^9 is not equal to nanoseconds.
        //                                 Milliseconds * 10^6 is equal to nanoseconds.
        // OYK_2013_07_26 : time.tv_nsec = (ms % 1000) * 1000000000;
